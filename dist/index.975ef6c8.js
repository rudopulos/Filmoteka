...
var _header = require("../src/js/header");
var _footer = require("../src/js/footer");
var _movieButtons = require("./js/movieButtons");
var _membersModal = require("./js/members-modal");
var _scrollToTop = require("./js/scrollToTop");
var _fetchGenreList = require("./js/fetchGenreList");
var _pageBuilder = require("./js/pageBuilder");
var _fetchMovieApi = require("./js/fetchMovieApi");
var _loadMore = require("./js/loadMore");
var _search = require("../src/js/search");
var _galleryBuilder = require("./js/galleryBuilder");
// Funcția de inițializare a aplicației
const startingPagination = async ()=>{
    try {
        (0, _pageBuilder.showPage)(1); // Afișează pagina curentă (pagina 1)
        const genreList = await (0, _fetchGenreList.fetchGenreList)(); // Obtin lista de genuri (ACTIUNE, COMEDIE ETC)
        const popularMovies = await (0, _fetchMovieApi.fetchPopularMovies)(1); // Obtin lista de filmele populare pentru pagina curentă (pagina 1)
        (0, _galleryBuilder.handleResponse)(popularMovies, true, genreList); // Manipulez răspunsul API-ului cu funcția handleResponse
    } catch (error) {
...
if (loadMoreButton) loadMoreButton.addEventListener("click", (0, _loadMore.loadMoreMovies)); // Când se face clic pe buton, se apelează funcția loadMoreMovies

},{"../src/js/header":"bvS82","../src/js/footer":"fXl6u","./js/movieButtons":"adS2i","./js/members-modal":"hHrJX","./js/scrollToTop":"fuss5","./js/fetchGenreList":"dtKSA","./js/pageBuilder":"fNYgV","./js/fetchMovieApi":"h0U4v","./js/loadMore":"1sDp5","../src/js/search":"4TESp","./js/galleryBuilder":"2Hhhd"}],"bvS82":[function(require,module,exports) {

},{}],"fXl6u":[function(require,module,exports) {

},{}],"adS2i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "watchedButton", ()=>watchedButton);
parcelHelpers.export(exports, "queueButton", ()=>queueButton);
var _localStorage = require("./localStorage");
var _modalOpen = require("./modalOpen");
var _fetchMovieApi = require("./fetchMovieApi");
var _galleryBuilder = require("./galleryBuilder");
// Modific numele butoanelor atunci când sunt selectate
const watchedButton = document.getElementById("watched-button");
const queueButton = document.getElementById("queue-button");
if (watchedButton) watchedButton.addEventListener("click", ()=>{
    if (watchedButton.innerText === "Add to Watched") {
        watchedButton.innerText = "Watched";
        // Adăugați filmul la "Watched" în local storage
        (0, _localStorage.saveToLocalStorage)("watchedMovies", (0, _modalOpen.globalMovieId));
        ...
        (0, _localStorage.removeFromLocalStorage)("watchedMovies", (0, _modalOpen.globalMovieId));
        watchedButton.classList.remove("modal_watched_active"); // Eliminați clasa aici
    }
    const watchedMovies = (0, _localStorage.getFromLocalStorage)("watchedMovies");
    (0, _fetchMovieApi.fetchMoviesDetails)(watchedMovies).then((r)=>(0, _galleryBuilder.createMyLibraryGallery)(r));
});
if (queueButton) queueButton.addEventListener("click", ()=>{
    if (queueButton.innerText === "Add to Queue") {
        queueButton.innerText = "Queued";
        // Adăugați filmul la "Queue" în local storage
        (0, _localStorage.saveToLocalStorage)("queuedMovies", (0, _modalOpen.globalMovieId));
        ...
        (0, _localStorage.removeFromLocalStorage)("queuedMovies", (0, _modalOpen.globalMovieId));
        queueButton.classList.remove("modal_queue_active"); // Eliminați clasa aici
    }
    const queuedMovies = (0, _localStorage.getFromLocalStorage)("queuedMovies");
    (0, _fetchMovieApi.fetchMoviesDetails)(queuedMovies).then((r)=>(0, _galleryBuilder.createMyLibraryGallery)(r));
});

},{"./localStorage":"45bAM","./modalOpen":"9GAh7","./fetchMovieApi":"h0U4v","./galleryBuilder":"2Hhhd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"45bAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveToLocalStorage", ()=>saveToLocalStorage);
parcelHelpers.export(exports, "removeFromLocalStorage", ()=>removeFromLocalStorage);
parcelHelpers.export(exports, "getFromLocalStorage", ()=>getFromLocalStorage);
...
},{}],"9GAh7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "openModal", ()=>openModal);
parcelHelpers.export(exports, "globalMovieId", ()=>globalMovieId);
var _apiUtils = require("./apiUtils");
var _localStorage = require("./localStorage");
var _movieButtons = require("./movieButtons");
//Salvez ID-ul filmului
let globalMovieId = null;
const openModal = async (movieId)=>{
    try {
        // Obțineți detaliile complete ale filmului utilizând ID-ul
        const movieDetails = await (0, _apiUtils.fetchData)(`/movie/${movieId}`);
        ...
        if (watchedMovies.includes(movieId)) {
            (0, _movieButtons.watchedButton).classList.add("modal_watched_active");
            (0, _movieButtons.watchedButton).innerText = "Watched";
        } else {
            (0, _movieButtons.watchedButton).classList.remove("modal_watched_active");
            (0, _movieButtons.watchedButton).innerText = "Add to Watched";
        }
        if (queuedMovies.includes(movieId)) {
            (0, _movieButtons.queueButton).innerText = "Queued";
            (0, _movieButtons.queueButton).classList.add("modal_queue_active");
        } else {
            (0, _movieButtons.queueButton).innerText = "Add to Queue";
            (0, _movieButtons.queueButton).classList.remove("modal_queue_active");
        }
        ...
        const posterUrl = movieDetails.poster_path ? `https://image.tmdb.org/t/p/w500${movieDetails.poster_path}` : nullPoster;
        // Populez modalul cu detaliile obținute folosind structura HTML specificată
        modal.querySelector(".modal-content").innerHTML = `
    <div class="gallery__modal__img"><img src="${posterUrl}" alt="${movieDetails.title}" class="modal-movie-poster"></div>
    <div class="gallery__modal__details">
      <h3 class="modal-movie-title">${movieDetails.title}</h3>
      <p class="modal-movie-vote"><span class= "modal-movie-category">Vote / Votes:</span> <span><span class="modal-movie-category-detail">${roundedVoteAverage}</span> / ${movieDetails.vote_count}</span></p>
      <p class="modal-movie-popularity"><span class= "modal-movie-category">Popularity:</span> ${roundedPopularity}</p>
      <p class="modal-movie-original-title"><span class= "modal-movie-category">Original Title:</span> ${movieDetails.original_title}</p>
      <p class="modal-movie-genre"><span class= "modal-movie-category">Genre:</span> ${movieDetails.genres.map((genre)=>genre.name).join(", ")}</p>
      <p class="modal-movie-overview"><span class= "modal-movie-overview-category">ABOUT:</span> ${movieDetails.overview}</p>
    </div>`;
        // Afisez modalul
...
},{"./apiUtils":"drWA1","./localStorage":"45bAM","./movieButtons":"adS2i","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"drWA1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchData = async (path, params = {})=>{
    try {
        ...
        const response = await (0, _axiosDefault.default).get(url); // Efectuează cererea la API folosind Axios
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h0U4v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "fetchMoviesDetails", ()=>fetchMoviesDetails);
var _apiUtils = require("./apiUtils");
...
const fetchPopularMovies = async (page)=>{
    try {
        ...
        const data = await Promise.all([
            (0, _apiUtils.fetchData)("/trending/movie/week", params),
            timeout
        ]);
...
const fetchMovieDetails = async (movieId)=>{
    ...
    return (0, _apiUtils.fetchData)(`/movie/${movieId}`, params); // Efectuează cererea pentru detalii de film
};
...
},{"./apiUtils":"drWA1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Hhhd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleResponse", ()=>handleResponse);
parcelHelpers.export(exports, "getGalleryElement", ()=>(0, _clearGallery.getGalleryElement));
parcelHelpers.export(exports, "nullPoster", ()=>nullPoster);
parcelHelpers.export(exports, "createMyLibraryGallery", ()=>createMyLibraryGallery);
var _fetchGenreList = require("./fetchGenreList");
var _clearGallery = require("./clearGallery");
var _modalOpen = require("./modalOpen");
const nullPoster = "https://upload.wikimedia.org/wikipedia/commons/6/65/No-Image-Placeholder.svg";
...
const handleResponse = (data, shouldClearGallery = true, genreList)=>{
    const galleryElement = (0, _clearGallery.getGalleryElement)();
    if (!galleryElement) return;
    if (shouldClearGallery) (0, _clearGallery.clearGallery)();
    const markup = data.results.map((result, index)=>markupGalleryItem(result, genreList)).join("");
    ...
    galleryItems.forEach((item)=>{
        item.addEventListener("click", ()=>{
            ...
            (0, _modalOpen.openModal)(movieId);
        });
    });
};
const createMyLibraryGallery = (moviesList)=>{
    const myLibraryGalleryElement = (0, _clearGallery.getMyLibraryGalleryElement)();
    if (!myLibraryGalleryElement) return;
    (0, _clearGallery.clearMyLibraryGallery)();
    const markup = moviesList.map((result)=>markupMyLibraryGalleryItem(result)).join("");
    myLibraryGalleryElement.insertAdjacentHTML("beforeend", markup);
    const galleryItems = myLibraryGalleryElement.querySelectorAll(".gallery__items");
    galleryItems.forEach((item)=>{
        item.addEventListener("click", ()=>{
            const movieId = item.getAttribute("data-id");
            (0, _modalOpen.openModal)(movieId);
...
const markupMyLibraryGalleryItem = (movie)=>{
    ...
    <li class="gallery__items" data-id="${id}">
      ...
      <div class="gallery__items__details">
        ...
        <p class="gallery__items__details--genres">${genres.map((g)=>g.name).join(", ")} | <span class="gallery__items__details--year">${year}</span>
      </p>
      </div>
    </li>
  `;
...
const markupGalleryItem = (result, genreList)=>{
    ...
    const coverUrl = poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : nullPoster;
    const genres = genre_ids ? (0, _fetchGenreList.getGenres)(genre_ids, genreList) : [
        "Unknown"
    ];
    const year = release_date ? release_date.slice(0, 4) : "N/A";
    return `
    <li class="gallery__items" data-id="${id}">
      ...
      <div class="gallery__items__details">
        <p class="gallery__items__details--title">${title}</p>
        <p class="gallery__items__details--genres">${genres.join(", ")} | <span class="gallery__items__details--year">${year}</span>
      </p>
      </div>
    </li>
  `;
...
},{"./fetchGenreList":"dtKSA","./clearGallery":"cNgxf","./modalOpen":"9GAh7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dtKSA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchGenreList", ()=>fetchGenreList);
...
const fetchGenreList = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get(`${URL}/genre/movie/list?api_key=${API_KEY}`);
...
const getGenres = (genreIds, genres)=>{
    const arr = [];
    if (!genreIds || !genres) arr.push("Unknown"); // Adăugați o valoare implicită în caz de lipsă de date
    else {
        for (const id of genreIds){
            const genre1 = genres.find((genre)=>genre.id === id);
            if (genre1) arr.push(genre1.name);
        }
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cNgxf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "clearGallery", ()=>clearGallery);
parcelHelpers.export(exports, "clearMyLibraryGallery", ()=>clearMyLibraryGallery);
parcelHelpers.export(exports, "getGalleryElement", ()=>getGalleryElement);
parcelHelpers.export(exports, "getMyLibraryGalleryElement", ()=>getMyLibraryGalleryElement);
...
const getMyLibraryGalleryElement = ()=>document.querySelector(".my-library-gallery");
...
const clearGallery = ()=>{
    ...
    if (galleryElement) galleryElement.innerHTML = ""; // Dacă există, șterge toate elementele din galerie
};
const clearMyLibraryGallery = ()=>{
    ...
    // Verifică dacă s-a găsit elementul galeriei
    if (myLibraryGalleryElement) myLibraryGalleryElement.innerHTML = ""; // Dacă există, șterge toate elementele din galerie
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hHrJX":[function(require,module,exports) {
...
},{}],"fuss5":[function(require,module,exports) {
// ===== Scroll to Top ==== 
$(window).scroll(function() {
    if ($(this).scrollTop() >= 50) $("#return-to-top").fadeIn(200); // Fade in the arrow
...
},{}],"fNYgV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const showPage = async (page, isSearch = false, searchQuery = "")=>{
    try {
        const genreList = await (0, _fetchGenreList.fetchGenreList)();
        let response;
        if (isSearch) {
            response = await fetchMovies(searchQuery, page);
            (0, _galleryBuilder.handleResponse)(response, true, genreList); // Se șterge conținutul galeriei când se face o căutare
        } else {
            response = await (0, _fetchMovieApi.fetchPopularMovies)(page);
            (0, _galleryBuilder.handleResponse)(response, page === 1, genreList); // Se menține conținutul existent al galeriei pentru paginile următoare
        }
    } catch (error) {
...
},{"./fetchGenreList":"dtKSA","./galleryBuilder":"2Hhhd","./fetchMovieApi":"h0U4v","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1sDp5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Exportați funcția loadMoreMovies pentru a o face disponibilă pentru import
parcelHelpers.export(exports, "loadMoreMovies", ()=>loadMoreMovies);
...
const loadMoreMovies = async ()=>{
    ...
    try {
        ...
        await (0, _pageBuilder.showPage)(currentPage, false); // `false` indică că nu este o căutare, ci solicitarea pentru filme populare
...
},{"./pageBuilder":"fNYgV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4TESp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");
var _themoviedbApi = require("./themoviedb-api");
var _themoviedbApiDefault = parcelHelpers.interopDefault(_themoviedbApi);
var _galleryBuilder = require("./galleryBuilder");
const form = document.querySelector(".search-form");
if (!form) return;
const api = new (0, _themoviedbApiDefault.default)();
...
function onSearchFormSubmit(event) {
    ...
    if (!queryString) {
        ...
        (0, _notiflixNotifyAio.Notify).failure("You must enter a movie name.");
        return;
    }
    api.getMoviesByName(queryString).then((res)=>{
        if (res.results.length < 1) (0, _notiflixNotifyAio.Notify).failure("Search result not successful. Enter the correct movie name.");
        else {
            (0, _notiflixNotifyAio.Notify).success("Results found successfully.");
            (0, _galleryBuilder.handleResponse)(res, true); // Afișează rezultatele căutării în galerie
        }
    }).catch((err)=>{
        (0, _notiflixNotifyAio.Notify).failure("A ap\u0103rut o eroare \xeen timpul c\u0103ut\u0103rii.");
    }).finally(()=>form.reset());
}

},{"notiflix/build/notiflix-notify-aio":"eXQLZ","./themoviedb-api":"kq1qQ","./galleryBuilder":"2Hhhd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"kq1qQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
